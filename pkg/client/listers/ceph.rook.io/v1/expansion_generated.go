...
// NvmeOfStorageNamespaceListerExpansion allows custom methods to be added to
// NvmeOfStorageNamespaceLister.
type NvmeOfStorageNamespaceListerExpansion interface{}
